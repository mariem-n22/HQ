        ...
        <div className="mt-10">
          <SettingsForm
            settings={{
              ...
              archdaily: settings?.archdaily ?? "",
              behance: settings?.behance ?? "",
              instagram: settings?.instagram ?? "",
              location: settings?.location ?? "",
              availability: settings?.availability ?? "",
              philosophyQuote: settings?.philosophyQuote ?? "",
              homeHeroUrl: settings?.homeHeroUrl ?? "",
              homeHeroCredit: settings?.homeHeroCredit ?? "",
              signatureStatement: settings?.signatureStatement ?? "",
              locations: settings?.locations ?? [],
              statementHeadline: settings?.statementHeadline ?? "",
